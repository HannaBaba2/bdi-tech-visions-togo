...
const Hero = () => {
  ...
  return (
    <section 
      id="accueil" 
      className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20 pb-12 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100"
    >
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Texte animé rotatif */}
          <div 
            className="text-base sm:text-xl md:text-2xl text-gray-600 mb-6 sm:mb-8 h-14 sm:h-16 flex items-center justify-center animate-slide-in-left" 
