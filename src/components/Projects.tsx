            ...
            <Card className="glass-effect border-0 shadow-2xl">
              <CardHeader>
                <div className="flex items-center space-x-4 mb-4">
                  <div className={`w-16 h-16 bg-gradient-to-r ${projects[selectedProject].color} rounded-2xl flex items-center justify-center text-2xl animate-glow`}>
                  ...
                  <div>
                    ...
                    <div className={`inline-block px-3 py-1 bg-gradient-to-r ${projects[selectedProject].color} text-white text-sm rounded-full mt-2`}>
              ...
              <CardContent>
                ...
                <div className="flex space-x-4">
                  <Button className={`bg-gradient-to-r ${projects[selectedProject].color} hover:scale-105 transition-transform`}>
                    En savoir plus
                  </Button>
